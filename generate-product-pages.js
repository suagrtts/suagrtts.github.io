...
// Create product_pages directory if it doesn't exist
const pagesDir = path.join(__dirname, 'product_pages');
...
// HTML template for each product page
...
<body>
    ...
    <header class="navbar">
        ...
        <nav class="nav-links">
            ...
            <a href="../favorites.html" class="favorites-icon">Favorites ❤️<span class="favorites-count">0</span></a>
    ...
    <div class="product-container">
        ...
        <div class="product-info">
            ...
            <div class="product-meta">
                ${product.brand ? `<span class="brand">Brand: ${product.brand}</span> | ` : ''}
                <span class="style">Style: ${product.style}</span>
            </div>
            <p class="product-description">${product.description}</p>
            <div class="price-container">
                <span class="original-price">₱${originalPrice.toLocaleString('en-PH', {minimumFractionDigits:2})}</span>
                <span class="product-price">₱${price.toLocaleString('en-PH', {minimumFractionDigits:2})}</span>
    ...
    <script>
        ...
        function toggleFavorite() {
            ...
            const index = favorites.findIndex(f => f.slug === product.id);
            if (index === -1) {
        ...
        function checkFavoriteStatus() {
            const favorites = JSON.parse(localStorage.getItem('favorites') || '[]');
            const isFavorite = favorites.some(f => f.slug === product.slug);
            if (isFavorite) {
